...
def _(onnx_node: OnnxNode, onnx_model: OnnxModel):
    min_val = onnx_model.get_initializer_by_name(onnx_node.input_names[1])
    max_val = onnx_model.get_initializer_by_name(onnx_node.input_names[2])
    ...
    onnx_mapping = {
        'name': onnx_node.name,
        'inputs': onnx_node.input_names[:1],
